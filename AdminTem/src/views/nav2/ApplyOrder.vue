    ...
    <div class="approving-order">
        ...
        <div class="search-div">
            ...
            <div class="search-block" style="max-width: 120px">
                <el-select v-model="listQuery.orderStatus" placeholder="状态过滤">
                    <el-option
            ...
            <div class="search-block">
                <el-button style="background-color: #409eff;" type="primary" icon="el-icon-search" @click="getSubmitOrderList">搜索</el-button>
            </div>
        </div>
        ...
        <div class="search-div">
            <div class="search-block">
                <el-button :autofocus="true" :class="{timeActive:activeList[0]}" type="info" @click="timeFilter('today',0)">今日工单</el-button>
                <el-button :autofocus="true" :class="{timeActive:activeList[1]}"  type="info" @click="timeFilter('week',1)">最近一周</el-button>
                <el-button :autofocus="true" :class="{timeActive:activeList[2]}" type="info" @click="timeFilter('month',2)">最近一月</el-button>
            </div>
        </div>
            ...
            >
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="approving(scope.row.id)" type="text" size="mini">详情</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
	...
	import {ApplyOrder} from "../../api/api.js"
    export default {
        data() {
            return {
                loading: true,
        ...
        methods: {
            ...
            getSubmitOrderList () {
                var parms = {
                    order_status: this.listQuery.orderStatus,
            ...
            handleSizeChange (val) {
				...
				console.log(this.listQuery.defaultPageSize)
